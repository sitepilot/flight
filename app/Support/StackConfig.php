...
abstract class StackConfig
{
    ...
    /**
     * Where the stack's generated files are written, next to its config
     * file, which holds the user's own.
     */
     ...
     * written. Generated files stay out of git, without touching the
     * user's own .gitignore.
     */
    ...
    /**
     * The files listed under `compose` that exist, as absolute paths. They
     * run after the generated file, so they can change what Flight
     * generates. A missing file is an error unless it is marked
     * `required: false`.
     *
    ...
    /**
     * Allow `compose.yml` as well as `{path: compose.yml}`. A file is
